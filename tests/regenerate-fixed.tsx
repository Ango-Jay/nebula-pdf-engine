...
async function main() {
  ...
  const outPath = path.join(path.dirname(new URL(import.meta.url).pathname), '..', 'table_transactions_fixed.pdf');
  fs.writeFileSync(outPath, pdfBuffer);
  console.log(`✅ Written to ${outPath} (${pdfBuffer.length} bytes)`);
}
